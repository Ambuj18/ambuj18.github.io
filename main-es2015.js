...
let AppComponent = class AppComponent {
    ...
    updatePolicy(policy) {
        this.policyService.updatePolicy(policy).subscribe((ret) => {
            ...
            this.url = "/dashboard";
            this.testzone = false;
            if (this.testscore == 500) {
                document.getElementById('btn').click();
                this.message = " You have scored well good!";
...
let DashboardComponent = class DashboardComponent {
    ...
    ngOnInit() {
        ...
        this.policyService.getPolicy(this.app.id).subscribe((data) => {
            ...
            let str = (this.aptiscore / 10) * 2 + "%";
            document.getElementById("apti").style.width = str;
            this.engscore = data.scoreEng;
            let str2 = (this.engscore / 10) * 2 + "%";
            document.getElementById("eng").style.width = str2;
            this.reascore = data.ScoreM;
            let str3 = (this.reascore / 10) * 2 + "%";
            document.getElementById("rea").style.width = str3;
            this.proscore = data.ScoreGK;
            let str4 = (this.proscore / 10) * 2 + "%";
